...
typedef struct { /*!< (@ 0x40000000) MHU_A32_M55HE_0_RX Structure                               */
    __IOM MHU_A32_M55HE_0_RX_MHU_RX_CHANNEL_CFG_Type MHU_RX_CHANNEL_CFG[2]; /*!< (@ 0x00000000)
                                                                               [0..1] */
...
typedef struct { /*!< (@ 0x40010000) MHU_M55HE_A32_0_TX Structure                               */
    __IOM MHU_M55HE_A32_0_TX_MHU_TX_CHANNEL_CFG_Type MHU_TX_CHANNEL_CFG[2]; /*!< (@ 0x00000000)
                                                                               [0..1] */
    __IM uint32_t  RESERVED[976];
