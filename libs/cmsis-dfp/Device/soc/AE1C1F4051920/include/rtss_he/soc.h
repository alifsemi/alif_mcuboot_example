...
typedef struct { /*!< (@ 0x40040000) MHU_SECPU_M55HE_0_RX Structure                             */
    __IOM MHU_SECPU_M55HE_0_RX_MHU_RX_CHANNEL_CFG_Type MHU_RX_CHANNEL_CFG[2]; /*!< (@ 0x00000000)
                                                                                 [0..1] */
...
typedef struct { /*!< (@ 0x40050000) MHU_M55HE_SECPU_0_TX Structure                             */
    __IOM MHU_M55HE_SECPU_0_TX_MHU_TX_CHANNEL_CFG_Type MHU_TX_CHANNEL_CFG[2]; /*!< (@ 0x00000000)
                                                                                 [0..1] */
    __IM uint32_t  RESERVED[976];
