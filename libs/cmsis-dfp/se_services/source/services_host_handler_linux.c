...
struct rpmsg_endpoint_info s_mhu_eptinfo[MHU_NUMBER] = {{"se_mhu0", 0XFFFFFFFF, 0xFFFFFFFF},
                               ...
                               uint32_t service_timeout)
{
    ...
    service_header_t *p_header =
        (service_header_t *) (uintptr_t) s_services_host.packet_buffer_address;
    ...
    int      status =
        write(s_rpmsg_fd[mhu_id], &s_services_host.packet_buffer_address, sizeof(uint32_t));
