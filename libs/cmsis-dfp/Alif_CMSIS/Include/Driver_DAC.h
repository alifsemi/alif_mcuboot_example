...
typedef struct ARM_Driver_DAC {
    ...
    (void); /* pointer is pointing to DAC_GetVersion : used to get the driver version        */
    ARM_DAC_CAPABILITIES (*GetCapabilities)
    (void); /* pointer is pointing to DAC_Capabilities : used to get the driver capabilities */
    ...
    int32_t (*PowerControl)(ARM_POWER_STATE state); /* Pointer to DAC_PowerControl : Control DAC
                                                       Interface Power                     */
    int32_t (*Control)(uint32_t control,
                       uint32_t arg);    /* Pointer to DAC_Control : Control DAC Interface    */
