...
typedef enum _CAMERA_SENSOR_I2C_REG_ADDR_TYPE {
    ...
    CAMERA_SENSOR_I2C_REG_ADDR_TYPE_16BIT =
        2, /* Camera Sensor i2c Register Address type : 16-bit */
...
typedef struct CAMERA_SENSOR_SLAVE_I2C_CONFIG {
    ...
    CAMERA_SENSOR_I2C_REG_ADDR_TYPE cam_sensor_slave_reg_addr_type; /* Camera Sensor slave i2c
...
int32_t camera_sensor_i2c_write_burst(CAMERA_SENSOR_SLAVE_I2C_CONFIG *i2c, uint32_t reg_addr,
                                      void *reg_values, CAMERA_SENSOR_I2C_REG_SIZE reg_size,
                                      uint32_t burst_len);

/* read value from Camera Sensor slave register using i2c. */
int32_t camera_sensor_i2c_read(CAMERA_SENSOR_SLAVE_I2C_CONFIG *i2c, uint32_t reg_addr,
                               uint32_t *reg_value, CAMERA_SENSOR_I2C_REG_SIZE reg_size);
