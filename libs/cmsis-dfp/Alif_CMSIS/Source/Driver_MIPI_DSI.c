...
/*Driver Version*/
static const ARM_DRIVER_VERSION DriverVersion             = {ARM_MIPI_DSI_API_VERSION,
                              ...
                              DISPLAY_PANEL_DEVICE *display_panel, DSI_RESOURCES *dsi)
{
     ...
     */
    dsi->horizontal_timing = (display_panel->hsync_time + display_panel->hbp_time +
                              display_panel->hfp_time + display_panel->hactive_time);

    dsi->vertical_timing   = (display_panel->vsync_line + display_panel->vbp_line +
                            display_panel->vfp_line + display_panel->vactive_line);
...
/**
  ...
  \return      \ref execution_status.
  */
static int32_t DSI_PowerControl(ARM_POWER_STATE state, DSI_RESOURCES *dsi)
{
    if (dsi->state.initialized == 0) {
        return ARM_DRIVER_ERROR;
    }
...
static int32_t DSI_ConfigureHost(DSI_RESOURCES *dsi)
{
    ...
    dsi_irq0_enable(dsi->reg_base,
                    DSI_IRQ0_ACK_WITH_ERR_0 | DSI_IRQ0_ACK_WITH_ERR_1 | DSI_IRQ0_ACK_WITH_ERR_2 |
                        DSI_IRQ0_ACK_WITH_ERR_3 | DSI_IRQ0_ACK_WITH_ERR_4 |
                        DSI_IRQ0_ACK_WITH_ERR_5 | DSI_IRQ0_ACK_WITH_ERR_6 |
                        DSI_IRQ0_ACK_WITH_ERR_7 | DSI_IRQ0_ACK_WITH_ERR_8 |
                        DSI_IRQ0_ACK_WITH_ERR_9 | DSI_IRQ0_ACK_WITH_ERR_10 |
                        DSI_IRQ0_ACK_WITH_ERR_11 | DSI_IRQ0_ACK_WITH_ERR_12 |
                        DSI_IRQ0_ACK_WITH_ERR_13 | DSI_IRQ0_ACK_WITH_ERR_14 |
                        DSI_IRQ0_ACK_WITH_ERR_15 | DSI_IRQ0_DPHY_ERRORS_0 | DSI_IRQ0_DPHY_ERRORS_1 |
                        DSI_IRQ0_DPHY_ERRORS_2 | DSI_IRQ0_DPHY_ERRORS_3 | DSI_IRQ0_DPHY_ERRORS_4);

    dsi_irq1_enable(dsi->reg_base,
                    DSI_IRQ1_TO_HS_TX | DSI_IRQ1_TO_LP_RX | DSI_IRQ1_ECC_SINGLE_ERR |
                        DSI_IRQ1_ECC_MILTI_ERR | DSI_IRQ1_CRC_ERR | DSI_IRQ1_PKT_SIZE_ERR |
                        DSI_IRQ1_EOPT_ERR | DSI_IRQ1_DPI_PLD_WR_ERR | DSI_IRQ1_GEN_CMD_WR_ERR |
...
static int32_t DSI_ConfigureDPI(DISPLAY_PANEL_DEVICE *display_panel, DSI_RESOURCES *dsi)
{
    ...
    dsi_set_video_hline_time(dsi->reg_base,
                             ((display_panel->hsync_time << 1) + (display_panel->hbp_time << 1) +
                              (display_panel->hfp_time << 1) + (display_panel->hactive_time << 1)));
...
/**
  \fn          int32_t  DSI_StartCommandMode (DISPLAY_PANEL_DEVICE *display_panel, DSI_RESOURCES
  *dsi) \brief       Configure DSI to start Command mode. \param[in]   display_panel Pointer to
  display panel resources. \param[in]   dsi  Pointer to DSI resources. \return      \ref
  execution_status.
*/
static int32_t DSI_StartCommandMode(DISPLAY_PANEL_DEVICE *display_panel, DSI_RESOURCES *dsi)
{
    ...
    dsi_set_command_mode_config(dsi->reg_base,
                                DSI_CMD_MODE_CFG_GEN_SW_0P_TX | DSI_CMD_MODE_CFG_GEN_SW_1P_TX |
                                    DSI_CMD_MODE_CFG_GEN_SW_2P_TX | DSI_CMD_MODE_CFG_GEN_SR_0P_TX |
                                    DSI_CMD_MODE_CFG_GEN_SR_1P_TX | DSI_CMD_MODE_CFG_GEN_SR_2P_TX |
                                    DSI_CMD_MODE_CFG_GEN_LW_TX | DSI_CMD_MODE_CFG_DCS_SW_0P_TX |
                                    DSI_CMD_MODE_CFG_DCS_SW_1P_TX | DSI_CMD_MODE_CFG_DCS_SR_0P_TX |
                                    DSI_CMD_MODE_CFG_DCS_LW_TX | DSI_CMD_MODE_CFG_MAX_RD_PKT_SIZE);
...
static void MIPI_DSI_ISR(DSI_RESOURCES *dsi)
{
    ...
    if (int_st & (DSI_IRQ0_ACK_WITH_ERR_0 | DSI_IRQ0_ACK_WITH_ERR_1 | DSI_IRQ0_ACK_WITH_ERR_2 |
                  DSI_IRQ0_ACK_WITH_ERR_3 | DSI_IRQ0_ACK_WITH_ERR_4 | DSI_IRQ0_ACK_WITH_ERR_5 |
                  DSI_IRQ0_ACK_WITH_ERR_6 | DSI_IRQ0_ACK_WITH_ERR_7 | DSI_IRQ0_ACK_WITH_ERR_8 |
                  DSI_IRQ0_ACK_WITH_ERR_9 | DSI_IRQ0_ACK_WITH_ERR_10 | DSI_IRQ0_ACK_WITH_ERR_11 |
                  DSI_IRQ0_ACK_WITH_ERR_12 | DSI_IRQ0_ACK_WITH_ERR_13 | DSI_IRQ0_ACK_WITH_ERR_14 |
                  DSI_IRQ0_ACK_WITH_ERR_15)) {
        dsi->cb_event(DSI_PHY_ERROR_EVENT);
    }

    if (int_st & (DSI_IRQ0_DPHY_ERRORS_0 | DSI_IRQ0_DPHY_ERRORS_1 | DSI_IRQ0_DPHY_ERRORS_3 |
    ...
    if (int_st &
        (DSI_IRQ1_TO_HS_TX | DSI_IRQ1_TO_LP_RX | DSI_IRQ1_ECC_SINGLE_ERR | DSI_IRQ1_ECC_MILTI_ERR |
         DSI_IRQ1_CRC_ERR | DSI_IRQ1_PKT_SIZE_ERR | DSI_IRQ1_EOPT_ERR)) {
        dsi->cb_event(DSI_PKT_ERROR_EVENT);
    }

    if (int_st & (DSI_IRQ1_DPI_PLD_WR_ERR | DSI_IRQ1_GEN_CMD_WR_ERR | DSI_IRQ1_GEN_PLD_WR_ERR |
                  DSI_IRQ1_GEN_PLD_SEND_ERR | DSI_IRQ1_GEN_PLD_RD_ERR | DSI_IRQ1_GEN_PLD_RECEV_ERR |
