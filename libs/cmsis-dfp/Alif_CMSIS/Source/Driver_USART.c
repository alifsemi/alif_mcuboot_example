...
/**
  ...
  \return      \ref        execution_status
*/
static inline int32_t USART_DMA_Usermcode(DMA_PERIPHERAL_CONFIG *dma_periph, uint32_t dma_mcode)
{
    int32_t         status;
    ARM_DRIVER_DMA *dma_drv = dma_periph->dma_drv;
...
/**
  ...
  \return      \ref         execution_status
*/
__STATIC_INLINE int32_t UART_DMA_GetStatus(DMA_PERIPHERAL_CONFIG *dma_periph, uint32_t *count)
{
    int32_t         status;
    ARM_DRIVER_DMA *dma_drv = dma_periph->dma_drv;
 ...
 */
static int32_t ARM_USART_PowerControl(ARM_POWER_STATE state, UART_RESOURCES *uart)
{
    switch (state) {
    case ARM_POWER_OFF:
        /* Disable uart IRQ */
    ...
    case ARM_POWER_FULL:
        ...
        if (uart->instance == UART_INSTANCE_LP) /* LPUART */ {
            ...
            if (uart->dma_enable) {
                 ...
                 *  DMA0 or DMA1?
                 */
                if ((uart->instance >= UART_INSTANCE_4) && (uart->instance <= UART_INSTANCE_7)) {
                    /* DMA1 is selected? */
 ...
 * @retval  \ref execution_status
 */
static int32_t ARM_USART_Initialize(ARM_USART_SignalEvent_t cb_event, UART_RESOURCES *uart)
{
 ...
 * @retval  \ref execution_status
 */
static int32_t ARM_USART_Send(const void *data, uint32_t num, UART_RESOURCES *uart)
{
    if ((data == NULL) || (num == 0U)) {
        /* invalid parameters */
        return ARM_DRIVER_ERROR_PARAMETER;
 ...
 * @retval  \ref execution_status
 */
static int32_t ARM_USART_Receive(void *data, uint32_t num, UART_RESOURCES *uart)
{
    if ((data == NULL) || (num == 0U)) {
        /* invalid parameters */
        return ARM_DRIVER_ERROR_PARAMETER;
 ...
 * @retval  \ref execution_status
 */
static int32_t UartAsynchronousModeCtrl(UART_RESOURCES *uart, uint32_t control, uint32_t arg)
{
 ...
 */
static int32_t ARM_USART_Control(uint32_t control, uint32_t arg, UART_RESOURCES *uart)
{
 ...
 * @retval  \ref execution_status
 */
static int32_t ARM_USART_SetModemControl(ARM_USART_MODEM_CONTROL control, UART_RESOURCES *uart)
{
    /* Added to fix Warning: unused parameter [-Wunused-parameter] */
    ARG_UNUSED(control);
    ARG_UNUSED(uart);
...
*/
static void UART_DMATxCallback(uint32_t event, int8_t peri_num, UART_RESOURCES *uart)
{
    /* Transfer Completed */
...
/**
  ...
  \param[in]   uart       Pointer to UART resources
*/
static void UART_DMARxCallback(uint32_t event, int8_t peri_num, UART_RESOURCES *uart)
{
    /* Transfer Completed */
    if (event & ARM_DMA_EVENT_COMPLETE) {
        switch (peri_num) {
...
static UART_RESOURCES UART4_RES = {
    ...
    .rs485_cfg.rs485_de_to_re_turn_around_time_16bit =
        RTE_UART4_RS485_DE_TO_RE_TURN_AROUND_TIME_16BIT,
    .rs485_cfg.rs485_re_to_de_turn_around_time_16bit =
        RTE_UART4_RS485_RE_TO_DE_TURN_AROUND_TIME_16BIT,
#else
    .rs485_cfg = {0},
...
static UART_RESOURCES UART5_RES = {
    ...
    .rs485_cfg.rs485_de_to_re_turn_around_time_16bit =
        RTE_UART5_RS485_DE_TO_RE_TURN_AROUND_TIME_16BIT,
    .rs485_cfg.rs485_re_to_de_turn_around_time_16bit =
        RTE_UART5_RS485_RE_TO_DE_TURN_AROUND_TIME_16BIT,
#else
    .rs485_cfg = {0},
...
static UART_RESOURCES UART6_RES = {
    ...
    .rs485_cfg.rs485_de_to_re_turn_around_time_16bit =
        RTE_UART6_RS485_DE_TO_RE_TURN_AROUND_TIME_16BIT,
    .rs485_cfg.rs485_re_to_de_turn_around_time_16bit =
        RTE_UART6_RS485_RE_TO_DE_TURN_AROUND_TIME_16BIT,
#else
    .rs485_cfg = {0},
...
static UART_RESOURCES UART7_RES = {
    ...
    .rs485_cfg.rs485_de_to_re_turn_around_time_16bit =
        RTE_UART7_RS485_DE_TO_RE_TURN_AROUND_TIME_16BIT,
    .rs485_cfg.rs485_re_to_de_turn_around_time_16bit =
        RTE_UART7_RS485_RE_TO_DE_TURN_AROUND_TIME_16BIT,
#else
    .rs485_cfg = {0},
