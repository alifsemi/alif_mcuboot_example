...
/**
  ...
  \return      \ref        execution_status
*/
__STATIC_INLINE int32_t I2S_DMA_Usermcode(DMA_PERIPHERAL_CONFIG *dma_periph, uint32_t dma_mcode)
{
    int32_t         status;
    ARM_DRIVER_DMA *dma_drv = dma_periph->dma_drv;
...
/**
  ...
  \return      \ref           execution_status
*/
__STATIC_INLINE int32_t I2S_DMA_Start(DMA_PERIPHERAL_CONFIG *dma_periph, ARM_DMA_PARAMS *dma_params)
{
    int32_t         status;
    ARM_DRIVER_DMA *dma_drv = dma_periph->dma_drv;
...
/**
  ...
  \return      \ref         execution_status
*/
__STATIC_INLINE int32_t I2S_DMA_GetStatus(DMA_PERIPHERAL_CONFIG *dma_periph, uint32_t *count)
{
    int32_t         status;
    ARM_DRIVER_DMA *dma_drv = dma_periph->dma_drv;
...
static int32_t I2S_Control(uint32_t control, uint32_t arg1, uint32_t arg2, I2S_RESOURCES *I2S_RES)
{
    ...
    case ARM_SAI_MCLK_PIN_INPUT:
        ...
        if (I2S_RES->cfg->master_mode) {
            ...
            mclk_prescaler = ((arg2 & ARM_SAI_MCLK_PRESCALER_Msk) >> ARM_SAI_MCLK_PRESCALER_Pos);
    ...
    /* Unsupported Codes */
    if ((control & ARM_SAI_COMPANDING_Msk) || (control & ARM_SAI_CLOCK_POLARITY_Msk)) {
        return ARM_DRIVER_ERROR_UNSUPPORTED;
    }
...
/**
  ...
  \param[in]   I2S_RES       Pointer to I2S resources
*/
static void I2S_DMACallback(uint32_t event, int8_t peri_num, I2S_RESOURCES *I2S_RES)
{
    if (!I2S_RES->cb_event) {
        return;
    }
...
*/
extern ARM_DRIVER_SAI Driver_SAILP;
