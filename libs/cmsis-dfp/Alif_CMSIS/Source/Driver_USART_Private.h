...
#if ((RTE_UART4_RS485_ENABLE) || (RTE_UART5_RS485_ENABLE) || (RTE_UART6_RS485_ENABLE) ||           \
     (RTE_UART7_RS485_ENABLE))
...
#if (RTE_UART0_BLOCKING_MODE_ENABLE || RTE_UART1_BLOCKING_MODE_ENABLE ||                           \
     RTE_UART2_BLOCKING_MODE_ENABLE || RTE_UART3_BLOCKING_MODE_ENABLE ||                           \
     RTE_UART4_BLOCKING_MODE_ENABLE || RTE_UART5_BLOCKING_MODE_ENABLE ||                           \
     RTE_UART6_BLOCKING_MODE_ENABLE || RTE_UART7_BLOCKING_MODE_ENABLE ||                           \
     RTE_LPUART_BLOCKING_MODE_ENABLE)
...
typedef struct _UART_RS485_CONFIG {
    ...
    uint8_t rs485_de_deassertion_time_8bit;         /* uart RS485 Driver Enable DE De-Assertion Time
                                                       (8-bit).                                */
    uint16_t rs485_de_to_re_turn_around_time_16bit; /* uart RS485 Turn Around Time TAT for Driver
                                                       Enable DE to Receive Enable RE (16-bit).   */
    uint16_t rs485_re_to_de_turn_around_time_16bit; /* uart RS485 Turn Around Time TAT for Receive
                                                       Enable RE to Driver Enable DE (16-bit).   */
} UART_RS485_CONFIG;
