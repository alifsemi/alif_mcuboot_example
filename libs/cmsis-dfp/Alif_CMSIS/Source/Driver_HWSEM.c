...
/* Driver Version */
static const ARM_DRIVER_VERSION DriverVersion = {ARM_HWSEM_API_VERSION, ARM_HWSEM_DRV_VERSION};

/* Driver Capabilities */
static const ARM_HWSEM_CAPABILITIES DriverCapabilities = {1, /* Supports HWSEM callback */
                                                          0};
