...
/* Driver Version */
static const ARM_DRIVER_VERSION DriverVersion        = {ARM_WDT_API_VERSION, ARM_WDT_DRV_VERSION};
...
/**
  ...
  \return       \ref execution_status
*/
static int32_t WDT_PowerControl(ARM_POWER_STATE state, WDT_RESOURCES *wdt)
{
...
/**
  ...
  \return       \ref execution_status
*/
static int32_t WDT_Initialize(uint32_t timeout_msec, WDT_RESOURCES *wdt)
{
    if (!wdt) {
        return ARM_DRIVER_ERROR_PARAMETER;
    }
...
/**
  ...
  \return       \ref execution_status
*/
static int32_t WDT_Control(uint32_t control, uint32_t arg, WDT_RESOURCES *wdt)
{
    ARG_UNUSED(arg);
    int ret = ARM_DRIVER_OK;
...
static WDT_RESOURCES WDT0 = {.regs    = (WDT_CTRL_Type *) WDTLOCAL_CTRL_BASE,
                             .flags   = 0,
                             .timeout = 0};
