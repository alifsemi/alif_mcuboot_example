...
#define QEC_CAPTURE_A_IRQ(channel)                                                                 \
    (QEC_CAPTURE_A_IRQ_BASE + ((channel - ARM_UTIMER_CHANNEL12) * 2U))
#define QEC_CAPTURE_B_IRQ(channel)                                                                 \
    (QEC_CAPTURE_B_IRQ_BASE + ((channel - ARM_UTIMER_CHANNEL12) * 2U))
#endif
