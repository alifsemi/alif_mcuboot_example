...
#if (RTE_SPI0_DMA_ENABLE || RTE_SPI1_DMA_ENABLE || RTE_SPI2_DMA_ENABLE || RTE_SPI3_DMA_ENABLE ||   \
     RTE_LPSPI_DMA_ENABLE)
#define SPI_DMA_ENABLE 1
#else
#define SPI_DMA_ENABLE 0
#endif

#if (RTE_SPI0_BLOCKING_MODE_ENABLE || RTE_SPI1_BLOCKING_MODE_ENABLE ||                             \
     RTE_SPI2_BLOCKING_MODE_ENABLE || RTE_SPI3_BLOCKING_MODE_ENABLE ||                             \
     RTE_LPSPI_BLOCKING_MODE_ENABLE)
...
#if (RTE_SPI0_MICROWIRE_FRF_ENABLE || RTE_SPI1_MICROWIRE_FRF_ENABLE ||                             \
     RTE_SPI2_MICROWIRE_FRF_ENABLE || RTE_SPI3_MICROWIRE_FRF_ENABLE ||                             \
     RTE_LPSPI_MICROWIRE_FRF_ENABLE)
