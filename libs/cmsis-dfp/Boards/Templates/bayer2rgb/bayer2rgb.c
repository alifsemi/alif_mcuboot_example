...
/**
  ...
  \return      Success: 0;
               Error  : 1
*/
int32_t bayer_to_RGB(uint8_t *src, uint8_t *dest, uint32_t width, uint32_t height)
{
    ...
    case 8:
        dc1394_bayer_decoding_8bit((const uint8_t *) bayer,
                                   (uint8_t *) rgb_start,
                                   width,
                                   height,
                                   first_color,
    ...
    default:
        ...
        dc1394_bayer_decoding_16bit((const uint16_t *) bayer,
                                    (uint16_t *) rgb_start,
                                    width,
                                    height,
                                    first_color,
