...
const struct pinconf board_pinconf[] = {
    /* P6_2 on pin D14. Functions: [0]: >>>GPIO6_2<<<, [1]: OSPI0_D2_C, [2]: UART2_CTS_A, [3]:
    ...
    /* P6_4 on pin B14. Functions: [0]: >>>GPIO6_4<<<, [1]: OSPI0_D4_C, [2]: UART2_CTS_B, [3]:
    ...
    /* P6_6 on pin D16. Functions: [0]: >>>GPIO6_6<<<, [1]: OSPI0_D6_C, [2]: UART0_CTS_B, [3]:
    ...
    /* P7_4 on pin M22 {FLEX IO}. Functions: [0]: >>>GPIO7_4<<<, [1]: Reserved, [2]: LPUART_CTS_A,
    ...
    /* P12_0 on pin D2. Functions: [0]: >>>GPIO12_0<<<, [1]: OSPI0_SCLK_C, [2]: AUDIO_CLK_C, [3]:
       I2S1_SDI_B, [4]: UT8_T0_C, [5]: CDC_D8_B */
    /* Selected: GPIO12_0 */
    {PORT_12, PIN_0, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

    /* P12_3 on pin E7. Functions: [0]: >>>GPIO12_3<<<, [1]: OSPI0_SS0_C, [2]: UART4_DE_B, [3]:
