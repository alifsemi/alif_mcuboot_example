/******************************************************************************
 * @file     vio_DevKit-E8.c
 * @brief    Virtual I/O implementation for Alif Semiconductor Ensemble DevKit-E8
 * @version  V1.0.0
...
/*! \page vio_DevKit-E8 Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

Virtual Resource  | Variable       | Physical Resource on Ensemble DevKit-E8        |
:-----------------|:---------------|:-----------------------------------------------|
...
#define JOY_UP_PIN      GPIO_PIN(BOARD_JOY_SW_B_GPIO_PORT, BOARD_JOY_SW_B_GPIO_PIN)
#define JOY_DOWN_PIN    GPIO_PIN(BOARD_JOY_SW_C_GPIO_PORT, BOARD_JOY_SW_C_GPIO_PIN)
#define JOY_LEFT_PIN    GPIO_PIN(BOARD_JOY_SW_A_GPIO_PORT, BOARD_JOY_SW_A_GPIO_PIN)
