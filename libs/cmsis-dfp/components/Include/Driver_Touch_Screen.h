...
typedef struct _ARM_TOUCH_STATE {
    ...
    ARM_TOUCH_COORDINATES coordinates[RTE_ACTIVE_TOUCH_POINTS];  ///< Variable to store Touch
                                                                 ///< coordinates.
} ARM_TOUCH_STATE;
...
typedef struct _ARM_DRIVER_TOUCH_SCREEN {
    /* Pointer to \ref ARM_TOUCH_SCREEN_GetVersion : Get driver version                     */
    ARM_DRIVER_VERSION             (*GetVersion)      (void);
    /* Pointer to \ref ARM_TOUCT_SCREEN_GetCapabilities : Get driver capabilities           */
    ARM_TOUCH_SCREEN_CAPABILITIES  (*GetCapabilities) (void);
    /* Pointer to \ref ARM_TOUCH_SCREEN_Initialize : Initialize touch screen Interface      */
    int32_t                        (*Initialize)      (void);
    /* Pointer to \ref ARM_TOUCH_SCREEN_Uninitialize : Un-initialize touch screen Interface */
    int32_t                        (*Uninitialize)    (void);
    /* Pointer to \ref ARM_TOUCH_SCREEN_PowerControl : Control touch screen Interface Power */
    int32_t                        (*PowerControl)    (ARM_POWER_STATE state);
    /* Pointer to \ref ARM_TOUCH_SCREEN_GetState : Get touch screen touch state             */
    int32_t                        (*GetState)        (ARM_TOUCH_STATE *state);
