...
typedef struct {
    ...
    aes_regs_t *aes_regs;       ///< Pointer to AES0 or AES1 decryption module & XIP enable line
                                ///< registers
    ...
    uint32_t ser;  ///< Slave Select / Enable register - application defined (to drive ospiN_ss0 or
                   ///< ospiN_ss1)
