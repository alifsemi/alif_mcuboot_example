...
static uint32_t              s_receiver_frame_count;
 ...
 */
static __inline MHU_receiver_frame_register_t *get_receiver_frame_base_address(uint32_t receiver_id)
{
 ...
 */
static mhu_channel_combined_group_t
    sender_receiver_combined_ch_group(mhu_channel_number_t channel_number)
{
 ...
 * @return    None
 */
static void MHU_receiver_set_irq_enable(MHU_receiver_frame_register_t *receiver_reg_base,
...
void MHU_receiver_initialize(uint32_t receiver_frame_base_address_list[],
                             uint32_t receiver_frame_count, MHU_rx_msg_callback_t callback)
{
