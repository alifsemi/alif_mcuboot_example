...
typedef void (*MHU_send_msg_acked_callback_t)(uint32_t mhu_id, uint32_t channel_number);
typedef void (*MHU_rx_msg_callback_t)(uint32_t mhu_id, uint32_t channel_number,
...
typedef mhu_send_status_t (*MHU_send_message_t)(uint32_t mhu_id, uint32_t channel_number,
                                                uint32_t message_data);
