...
/**
  \fn          static inline void select_lptimer_clk (LPTIMER_RESOURCES LPTIMER_RES, uint8_t
  channel) \brief       LPTIMER input clock selection \param[in]   clk       clock \param[in]
  channel   used LPTIMER channel \return      none
*/
