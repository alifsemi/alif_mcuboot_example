...
#define ADC_THRSHLD_CMP_MASK_BIT                                                                   \
    (0x03 << ADC_THRSHLD_CMP_MASK_BIT_POS) /* Comparator threshold mask bit          */
...
typedef enum _ADC_CONV_STAT {
    ...
    ADC_CONV_STAT_CMP_THLD_ABOVE_A =
        (1U << 1), /* ADC Conversion status comparator threshold above A       */
    ADC_CONV_STAT_CMP_THLD_ABOVE_B =
        (1U << 2), /* ADC Conversion status comparator threshold above B       */
    ADC_CONV_STAT_CMP_THLD_BELOW_A =
        (1U << 3), /* ADC Conversion status comparator threshold below A       */
    ADC_CONV_STAT_CMP_THLD_BELOW_B =
        (1U << 4), /* ADC Conversion status comparator threshold below B       */
    ADC_CONV_STAT_CMP_THLD_BETWEEN_A_B =
 ...
 *    @return       : NONE
*/
static inline void adc_set_n_shift_bit(ADC_Type *adc, uint32_t shift_number,
                                       uint32_t shift_left_right_control)
{
