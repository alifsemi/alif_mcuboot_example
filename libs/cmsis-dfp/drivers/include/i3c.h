...
#define I3C_DEVICE_ADDR_DYNAMIC_ADDR(x)                                                            \
    (((x) << I3C_DEVICE_ADDR_DYNAMIC_ADDR_Pos) & I3C_DEVICE_ADDR_DYNAMIC_ADDR_Msk)
...
#define I3C_QUEUE_THLD_CTRL_CMD_EMPTY_BUF_THLD_Msk                                                 \
    GENMASK(7, I3C_QUEUE_THLD_CTRL_CMD_EMPTY_BUF_THLD_Pos)

#define I3C_DATA_BUFFER_THLD_CTRL_RX_BUF_THLD_Pos 8U
#define I3C_DATA_BUFFER_THLD_CTRL_RX_BUF_THLD_Msk                                                  \
    GENMASK(10, I3C_DATA_BUFFER_THLD_CTRL_RX_BUF_THLD_Pos)
...
#define I3C_INTR_STATUS_ALL                                                                        \
    (I3C_INTR_STATUS_BUSOWNER_UPDATED_STS | I3C_INTR_STATUS_IBI_UPDATED_STS |                      \
     I3C_INTR_STATUS_READ_REQ_RECV_STS | I3C_INTR_STATUS_DEFSLV_STS |                              \
     I3C_INTR_STATUS_TRANSFER_ERR_STS | I3C_INTR_STATUS_DYN_ADDR_ASSGN_STS |                       \
     I3C_INTR_STATUS_CCC_UPDATED_STS | I3C_INTR_STATUS_TRANSFER_ABORT_STS |                        \
     I3C_INTR_STATUS_RESP_READY_STS | I3C_INTR_STATUS_CMD_QUEUE_READY_STS |                        \
     I3C_INTR_STATUS_IBI_THLD_STS | I3C_INTR_STATUS_RX_THLD_STS | I3C_INTR_STATUS_TX_THLD_STS)
...
#define I3C_MASTER_DFLT_INTR_EN_MASK                                                               \
    (I3C_INTR_STATUS_EN_TRANSFER_ERR_STS_EN | I3C_INTR_STATUS_EN_IBI_THLD_STS_EN |                 \
     I3C_INTR_STATUS_EN_TRANSFER_ABORT_STS_EN | I3C_INTR_STATUS_EN_RESP_READY_STS_EN)
...
#define I3C_DATA_BUFFER_STATUS_LEVEL_RX_BUF_BLR_Msk                                                \
    (GENMASK(23, I3C_DATA_BUFFER_STATUS_LEVEL_RX_BUF_BLR_Pos))
#define I3C_DATA_BUFFER_STATUS_LEVEL_TX_BUF_EMPTY_LOC_Pos 0U
#define I3C_DATA_BUFFER_STATUS_LEVEL_TX_BUF_EMPTY_LOC_Msk                                          \
    (GENMASK(7, I3C_DATA_BUFFER_STATUS_LEVEL_TX_BUF_EMPTY_LOC_Pos))
...
#define I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID_Msk                                                  \
    GENMASK(15, I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID_Pos)
#define I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID(x)                                                   \
    ((x & I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID_Msk) >> I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID_Pos)
...
#define I3C_SLV_PID_VALUE_SLV_PART_ID(x)                                                           \
    ((x & I3C_SLV_PID_VALUE_SLV_PART_ID_Msk) >> I3C_SLV_PID_VALUE_SLV_PART_ID_Pos)
...
#define I3C_SLV_PID_VALUE_SLV_INST_ID(x)                                                           \
    ((x & I3C_SLV_PID_VALUE_SLV_INST_ID_Msk) >> I3C_SLV_PID_VALUE_SLV_INST_ID_Pos)
...
#define I3C_SLV_CHAR_CTRL_DCR(x)                     ((x & I3C_SLV_CHAR_CTRL_DCR_Msk) >> I3C_SLV_CHAR_CTRL_DCR_Pos)
...
#define I3C_MAX_READ_TURNAROUND_MXDS_MAX_RD_TURN(x)                                                \
    (x & I3C_MAX_READ_TURNAROUND_MXDS_MAX_RD_TURN_Msk)

#define I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED_Pos 8U
#define I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED_Msk                                                   \
    GENMASK(10, I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED_Pos)
#define I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED(x)                                                    \
    ((x & I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED_Msk) >> I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED_Pos)
...
#define I3C_SEC_DEV_CHAR_TABLE1_STATIC_ADDR_Msk         GENMASK(7, I3C_SEC_DEV_CHAR_TABLE1_STATIC_ADDR_Pos)
#define I3C_SEC_DEV_CHAR_TABLE1_STATIC_ADDR(x)                                                     \
    (((x) & I3C_SEC_DEV_CHAR_TABLE1_STATIC_ADDR_Msk) >> I3C_SEC_DEV_CHAR_TABLE1_STATIC_ADDR_Pos)

#define I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE_Pos 8U
#define I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE_Msk GENMASK(15, I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE_Pos)
#define I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE(x)                                                        \
    (((x) & I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE_Msk) >> I3C_SEC_DEV_CHAR_TABLE1_BCR_TYPE_Pos)
...
#define I3C_SEC_DEV_CHAR_TABLE1_DCR_TYPE(x)                                                        \
    (((x) & I3C_SEC_DEV_CHAR_TABLE1_DCR_TYPE_Msk) >> I3C_SEC_DEV_CHAR_TABLE1_DCR_TYPE_Pos)
...
#define I3C_SEC_DEV_CHAR_TABLE1_DYNAMIC_ADDR(x)                                                    \
    (((x) & I3C_SEC_DEV_CHAR_TABLE1_DYNAMIC_ADDR_Msk) >> I3C_SEC_DEV_CHAR_TABLE1_DYNAMIC_ADDR_Pos)
...
typedef enum _I3C_XFER_STATUS {
    ...
    I3C_XFER_STATUS_SLV_DYN_ADDR_ASSGN =
        (1UL << 6), /**< Transfer status slave dynamic address assigned */
    ...
    I3C_XFER_STATUS_ERROR_TX =
        (1UL << 10), /**< Transfer status error  Master/Slave TX and CCC SET */
    I3C_XFER_STATUS_ERROR_RX =
        (1UL << 11), /**< Transfer status error  Master/Slave RX and CCC GET */
    ...
    I3C_XFER_STATUS_SLV_HOT_JOIN_REQ =
        (1UL << 14), /**< Transfer status Slave Hot join request received*/
    I3C_XFER_STATUS_IBI_MASTERSHIP_REQ =
        (1UL << 15), /**< Transfer status Mastership request received    */
...
static inline void i3c_set_dcr(I3C_Type *i3c, const uint8_t val)
{
    ...
    temp                   |= ((val << I3C_SLV_CHAR_CTRL_DCR_Pos) & I3C_SLV_CHAR_CTRL_DCR_Msk);
...
static inline void i3c_slave_set_pid(I3C_Type *i3c, const i3c_slave_pid_t slv_pid)
{
    ...
    i3c->I3C_SLV_MIPI_ID_VALUE =
        (slv_pid.pid_sel | (slv_pid.mipi_mfg_id << I3C_SLV_MIPI_ID_VALUE_SLV_MIPI_MFG_ID_Pos));

    i3c->I3C_SLV_PID_VALUE = (slv_pid.dcr | (slv_pid.inst_id << I3C_SLV_PID_VALUE_SLV_INST_ID_Pos) |
                              (slv_pid.part_id << I3C_SLV_PID_VALUE_SLV_PART_ID_Pos));
}
...
{
    return I3C_MAX_READ_TURNAROUND_MXDS_MAX_RD_TURN(i3c->I3C_MAX_READ_TURNAROUND);
}
...
{
    return I3C_MAX_DATA_SPEED_MXDS_MAX_RD_SPEED(i3c->I3C_MAX_DATA_SPEED);
}
...
{
    return I3C_MAX_DATA_SPEED_MXDS_MAX_WR_SPEED(i3c->I3C_MAX_DATA_SPEED);
}
...
{
    return (
        (uint16_t) ((i3c->I3C_SLV_MAX_LEN & I3C_SLV_MAX_LEN_MRL_Msk) >> I3C_SLV_MAX_LEN_MRL_Pos));
}
...
static inline bool i3c_tx_buf_empty(I3C_Type *i3c)
{
    return ((i3c->I3C_DATA_BUFFER_STATUS_LEVEL &
             I3C_DATA_BUFFER_STATUS_LEVEL_TX_BUF_EMPTY_LOC_Msk) == I3C_MAX_DATA_BUF_LOC);
}
...
{
    return (
        ((i3c->I3C_DATA_BUFFER_STATUS_LEVEL & I3C_DATA_BUFFER_STATUS_LEVEL_TX_BUF_EMPTY_LOC_Msk) >>
...
{
    return (((i3c->I3C_DATA_BUFFER_STATUS_LEVEL & I3C_DATA_BUFFER_STATUS_LEVEL_RX_BUF_BLR_Msk) >>
...
{
    return ((i3c->I3C_QUEUE_STATUS_LEVEL & I3C_QUEUE_STATUS_LEVEL_RESP_BUF_BLR_Msk) != 0);
}
...
static inline uint8_t i3c_get_rx_buf_thld(I3C_Type *i3c)
{
    ...
    uint32_t rx_empty_loc =
        ((i3c->I3C_DATA_BUFFER_THLD_CTRL & I3C_DATA_BUFFER_THLD_CTRL_RX_BUF_THLD_Msk) >> 8);
...
static inline void i3c_flush_all_buffers(I3C_Type *i3c)
{
    ...
    i3c->I3C_RESET_CTRL |=
        (I3C_RESET_CTRL_IBI_QUEUE_RST | I3C_RESET_CTRL_RX_FIFO_RST | I3C_RESET_CTRL_TX_FIFO_RST |
         I3C_RESET_CTRL_RESP_QUEUE_RST | I3C_RESET_CTRL_CMD_QUEUE_RST);
}
...
/**
  ...
  \return       none
*/
static inline void i3c_update_dat(I3C_Type *i3c, uint32_t pos, uint32_t val)
{
...
/**
  ...
  \return       none
*/
static inline void i3c_add_slv_to_dat(I3C_Type *i3c, const uint32_t pos, const uint8_t dyn_addr,
                                      const uint8_t sta_addr)
{
    uint32_t val;
...
/**
  ...
  \return       none
*/
static inline void i3c_remove_slv_from_dat(I3C_Type *i3c, uint32_t pos)
{
...
/**
  ...
  \return       none
*/
static inline void i3c_update_slv_addr_in_dat(I3C_Type *i3c, uint32_t pos, uint8_t dyn_addr)
{
    uint32_t val;
...
/**
  ...
  \return       none
*/
static inline void i3c_set_slave_nack_retry_cnt(I3C_Type *i3c, const uint8_t pos,
                                                const uint8_t retry_cnt)
{
    uint32_t datp       = i3c_get_dat_addr(i3c);
    ...
    dest_addr |= ((retry_cnt << I3C_DAT_DEV_NACK_RETRY_CNT_Pos) & I3C_DAT_DEV_NACK_RETRY_CNT_Msk);
...
/**
  ...
  \return       none
*/
static inline void i3c_set_sda_tx_hold_time(I3C_Type *i3c, const uint8_t val)
{
    i3c->I3C_SDA_HOLD_SWITCH_DLY_TIMING = ((val << I3C_SDA_HOLD_SWITCH_DLY_TIMING_SDA_TX_HOLD_Pos) &
...
/**
  ...
  \return       none
*/
static inline void i3c_master_setup_hot_join_ctrl(I3C_Type *i3c, const bool enable)
{
    if (enable) {
...
/**
  ...
  \return       none
*/
static inline void i3c_master_setup_mst_req_ctrl(I3C_Type *i3c, const bool enable)
{
    if (enable) {
...
/**
  ...
  \return       none
*/
static inline void i3c_master_setup_slv_intr_req_ctrl(I3C_Type *i3c, const bool enable)
{
    if (enable) {
        /* Accepts Mastership request from slaves */
