...
*/
static inline void i2s_clock_enable(I2S_Type *i2s, I2S_SCLKG sclkg, I2S_WSS wss_len)
{
...
/**
  ...
  \param[in]   i2s  Pointer to I2S register map
*/
static inline void i2s_set_rx_triggerLevel(I2S_Type *i2s, uint8_t trigger_level)
{
...
/**
  ...
  \param[in]   i2s  Pointer to I2S register map
*/
static inline void i2s_set_tx_triggerLevel(I2S_Type *i2s, uint8_t trigger_level)
{
...
*/
static inline uint32_t i2s_get_sclk_frequency(uint32_t sample_rate, I2S_WSS wss_len)
{
