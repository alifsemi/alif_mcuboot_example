...
// Write to registers
#define WRITE_REGISTER_U8(Address, Value)    (*((uint8_t volatile *) (Address)) = (uint8_t) (Value))
#define WRITE_REGISTER_U16(Address, Value)   (*((uint16_t volatile *) (Address)) = (uint16_t) (Value))
#define WRITE_REGISTER_U32(Address, Value)   (*((uint32_t volatile *) (Address)) = (uint32_t) (Value))

// Bit operations
#define SET_REGISTER_BITS_U8(Address, Value) (*(volatile uint8_t *) (Address) |= (uint8_t) (Value))
...
#define CLEAR_AND_SET_BITS_U8(Address, AndData, OrData)                                            \
    WRITE_REGISTER_U8(Address,                                                                     \
                      (READ_REGISTER_8(Address) & ~(uint8_t) (AndData)) | (uint8_t) (OrData))
...
#define CLEAR_AND_SET_BITS_U16(Address, AndData, OrData)                                           \
    WRITE_REGISTER_U16(Address,                                                                    \
                       (READ_REGISTER_U16(Address) & ~(uint16_t) (AndData)) | (uint16_t) (OrData))
...
#define CLEAR_AND_SET_BITS_U32(Address, AndData, OrData)                                           \
    WRITE_REGISTER_U32(Address,                                                                    \
                       (READ_REGISTER_U32(Address) & ~(uint32_t) (AndData)) | (uint32_t) (OrData))
