...
#define CANFD_TRANSCEIVER_STANDBY_DELAY                                                            \
    3U /* CANFD transceiver requires 3us to switch from Stdby to Dominant state  */
...
#define CANFD_ACF_3_MASK_AIDEE                                                                     \
    (1U << 30U) /* 1- Accepts either std or ext frame, 0 - accepts both */
#define CANFD_ACF_3_MASK_AIDE_Pos (29U)
#define CANFD_ACF_3_MASK_AIDE                                                                      \
    (1U << 29U) /* 1 - Accepts only extended frame, 0-Accepts only std frames */
...
/**
  ...
  \return      none
*/
static inline void canfd_set_specification(CANFD_Type *canfd, const uint8_t spec)
{
...
/**
  ...
  \return      None
*/
static inline void canfd_enable_timestamp(CANFD_Type *canfd, const uint8_t position)
{
...
/**
  ...
  \return      None
*/
static inline void canfd_counter_set(CANFD_CNT_Type *canfd_cntr, const uint32_t value)
{
...
/**
  ...
  \return      None
*/
static inline void canfd_select_tx_buf(CANFD_Type *canfd, const uint8_t buf_type)
{
...
{
    return ((canfd->CANFD_TCTRL & CANFD_TCTRL_TSSTAT_Msk) != CANFD_TCTRL_SEC_BUF_FULL);
}
...
{
    return (canfd->CANFD_CFG_STAT & (CANFD_CFG_STAT_TACTIVE | CANFD_CFG_STAT_RACTIVE));
}
...
/**
  ...
  \return      none
*/
static inline void canfd_set_rbuf_overflow_mode(CANFD_Type *canfd, const uint8_t mode)
{
...
/**
  ...
  \return      none
*/
static inline void canfd_set_rbuf_storage_format(CANFD_Type *canfd, const uint8_t format)
{
...
/**
  ...
  \return      none
*/
static inline void canfd_set_rbuf_almost_full_warn_limit(CANFD_Type *canfd, const uint8_t val)
{
...
static inline void canfd_enable_tx_interrupts(CANFD_Type *canfd)
{
    ...
    canfd->CANFD_RTIE |= (CANFD_RTIE_TPIE | CANFD_RTIE_TSIE);
}
...
static inline void canfd_enable_rx_interrupts(CANFD_Type *canfd)
{
    ...
    canfd->CANFD_RTIE |= (CANFD_RTIE_RIE | CANFD_RTIE_ROIE | CANFD_RTIE_RFIE | CANFD_RTIE_RAFIE);
}
...
static inline void canfd_enable_error_interrupts(CANFD_Type *canfd)
{
    ...
    canfd->CANFD_ERRINT |= (CANFD_ERRINT_EPIE | CANFD_ERRINT_ALIE | CANFD_ERRINT_BEIE);
}
...
static inline void canfd_enable_normal_mode(CANFD_Type *canfd)
{
    ...
    canfd->CANFD_CFG_STAT &= ~(CANFD_CFG_STAT_RESET | CANFD_CFG_STAT_LBMI | CANFD_CFG_STAT_LBME);
...
{
    /* Disables the CANFD reset, Internal and External loopback*/
    canfd->CANFD_CFG_STAT &= ~(CANFD_CFG_STAT_RESET | CANFD_CFG_STAT_LBMI);
...
{
    /* Disables the CANFD reset, Internal and External loopback*/
    canfd->CANFD_CFG_STAT &= ~(CANFD_CFG_STAT_RESET | CANFD_CFG_STAT_LBME);
...
/**
  ...
  \return      none
*/
void canfd_set_nominal_bit_time(CANFD_Type *canfd, const uint32_t bitrate_seg,
                                const uint8_t prescaler);
...
/**
  ...
  \return      none
*/
void canfd_set_fd_bit_time(CANFD_Type *canfd, const uint32_t bitrate_seg, const uint8_t prescaler);
...
/**
  ...
  \return      none
*/
void canfd_get_acpt_fltr_data(CANFD_Type *canfd, canfd_acpt_fltr_t *filter_config);
...
/**
  ...
  \return      none
*/
void canfd_setup_tx_retrans(CANFD_Type *canfd, const uint8_t buf_type, const bool enable);
...
/**
  ...
  \return      none
*/
void canfd_setup_tx_delay_comp(CANFD_Type *canfd, const uint8_t offset, const bool enable);
...
/**
  ...
  \return      none
*/
void canfd_send(CANFD_Type *canfd, const canfd_tx_info_t tx_header, const uint8_t *data,
                const uint8_t size);
...
/**
  ...
  \return      none
*/
void canfd_send_blocking(CANFD_Type *canfd, const canfd_tx_info_t tx_header, const uint8_t *data,
                         const uint8_t size);
