...
typedef union _dma_ftr {
    ...
    struct {
        ...
        uint32_t ch_periph_err  : 1;  /*!< security aspect while executing
                                         DMAWFP/DMALDP/DMASTP/DMAFLUSHP */
...
*/
static inline void dma_enable_interrupt(DMA_Type *dma, uint8_t event_irq_select_index)
{
...
*/
static inline void dma_disable_interrupt(DMA_Type *dma, uint8_t event_irq_select_index)
{
    dma->DMA_INTEN &= ~(1U << event_irq_select_index);
}
...
*/
static inline bool dma_get_channel_fault_status(DMA_Type *dma, uint8_t channel_num)
{
...
*/
static inline DMA_THREAD_STATUS dma_get_channel_status(DMA_Type *dma, uint8_t channel_num)
{
...
*/
static inline uint32_t dma_get_channel_src_addr(DMA_Type *dma, uint8_t channel_num)
{
...
*/
static inline uint32_t dma_get_channel_dest_addr(DMA_Type *dma, uint8_t channel_num)
{
...
/**
  ...
  \return      void
*/
static inline void dma_execute(DMA_Type *dma, uint32_t dbginst0, uint32_t dbginst1)
{
